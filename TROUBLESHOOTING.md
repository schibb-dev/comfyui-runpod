...
- Host workflow: `npm run ui:dev:all` starts `experiments_ui_server.py` on **`127.0.0.1:8791`**. Vite’s default proxy targets **8791** (`workspace/experiments_ui/web/vite.config.ts`).
