...
**Next session focus:** optional hourly pick by `rating_effective` (after G); Discovery index watcher — see [`docs/RATINGS_V1_PLAN.md`](../docs/RATINGS_V1_PLAN.md).
