...
Gallery shows a **Tagging backlog** panel (backlog counts, adjustable SLA /
session / scan knobs, Drain now dry-run/Comfy) so enqueue≠GPU is visible
without leaving Stills.
